...
// import Dayone from "../../pages/account/secmodal/dayone";
// header bar blank
// function CardsHeader1({ name, parentName }) {
//   return <div className="header bg-dark pb-6"></div>;
// }
// import {modal} from "router.query"
...
function Dashboard() {
  ...
  const [usman, setUsman] = useState();
  const photo = async () => {
    const res = await authService.getInterest();
    setUsman(res.data);
  ...
  useEffect(() => {
    photo();
      setModal(()=>localStorage.getItem("setStorageModal"))
      console.log("value: ", localStorage.getItem("setStorageModal"), modal)
    }
  , []);
        ...
        <div>
          <ModalBody>
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <>
                <div>
                  <h1>Last step! Tell us what you're interested in</h1>
                  <h4>Pick 3(or more!) to start discovering new ideas</h4>
                </div>
              </>
            </div>
                  ...
                  <div className="maper">
                    <div className="img-area">
                      <label class="container">
                        ...
                        <img
                          className="image-run"
                          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTc4lIhZHDYws_nca_eWEjhqqFtwLX1ZM3VmA&usqp=CAU"
                        ></img>

                        {x.image_url}
                        <h6>{x.thumb_url}</h6>
                        <h1 className="head">{x.Title}</h1>
                        <p className="part">{x.id}</p>
                      </label>
                    </div>
                  </div>
                );
          ...
          <ModalFooter>
            <Button
              ...
              onClick={() => {
                counter < 3 ? (
                  alert("Minimum 3 selections allowed")
                ) : (
                  <>
                    {(toggle(), localStorage.setItem("setStorageModal", false))}
                  </>
                );
              }}
            >
      ...
      <div className="header bg-dark">
        <Container fluid>
          {/* <div>
            ...
            {modal && <Dayone Closemodal={setModal} />}
          </div> */}
      ...
      <Container className="mt--6" fluid>
              ...
              <Card className="bg-gradient-default">
                <CardBody>
                  <div className="mb-2">
                    ...
                    <span className="h1 text-white">450,340</span>
                    ...
                    <div>
                      ...
                      <span className="text-light">($450.34)</span>
                    </div>
                  </div>
                  <Button
                    block
              ...
              <CardHeader className="bg-transparent">
                <Row className="align-items-center">
                  <div className="col">
                    ...
                    <h5 className="h3 mb-0">Ads Shown</h5>
                  </div>
                  <div className="col">
        ...
        <Row>
          <Col xl="4">
            <Card>
              <CardHeader>
                <h5 className="h3 mb-0">Top Creators</h5>
              </CardHeader>
          ...
          <Col xl="4">
            <Card>
              <CardHeader>
                <h5 className="h3 mb-0">Top Local Offers</h5>
              </CardHeader>
          ...
          <Col xl="4">
            <Card>
              <CardHeader>
                <h5 className="h3 mb-0">Ad Versions</h5>
              </CardHeader>
