      ...
      <div className="navbar-inner">
        <Collapse navbar isOpen={true}>
          ...
          {/* <h6 className="navbar-heading p-0 text-muted">
            <span className="docs-normal">Important Links</span>
            <span className="docs-mini">D</span>
          </h6> */}
          {/* <Nav className="mb-md-3" navbar>
            <NavItem>
              <NavLink
                href="https://demos.creative-tim.com/nextjs-argon-dashboard-pro/admin/cards"
                target="_blank"
              >
                <i className="ni ni-spaceship" />
                <span className="nav-link-text">Template DOCS</span>
              </NavLink>
              <NavLink
                href="https://demos.creative-tim.com/nextjs-argon-dashboard-pro/admin/cards"
                target="_blank"
              >
                <i className="ni ni-spaceship" />
                <span className="nav-link-text">Become Rep</span>
              </NavLink>
            </NavItem>
            <NavItem>
              <NavLink href="/help" target="_blank">
                <i className="ni ni-palette" />
                <span className="nav-link-text">Help / Support</span>
              </NavLink>
            </NavItem>
            <NavItem></NavItem>
            <NavItem>
              <NavLink href="/partners" target="_blank">
                <i className="ni ni-chart-pie-35" />
                <span className="nav-link-text">Become a Partner</span>
              </NavLink>
            </NavItem>
          </Nav> */}
        </Collapse>
